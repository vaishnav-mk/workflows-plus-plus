/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b56a4bd6a518717c4627d93b72473abe)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		AI_GATEWAY_URL: "https://gateway.ai.cloudflare.com/v1/c714a393dbfabeb858a7dea729b5e8f8/cloudflare-blogs-rag/google-ai-studio/v1/models/gemini-2.0-flash:generateContent";
		AI_GATEWAY_TOKEN: "AIzaSyCLB3eP_aH7p7eWXtl4HAB-Gc-e92RoLak";
		CF_API_TOKEN: string;
		CF_ACCOUNT_ID: string;
		DEPLOYMENT_DO: DurableObjectNamespace /* DeploymentDurableObject from workflows-backend */;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_URL" | "AI_GATEWAY_TOKEN" | "CF_API_TOKEN" | "CF_ACCOUNT_ID">> {}
}
